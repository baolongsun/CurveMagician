...
```bash
nuitka --standalone --onefile --remove-output --no-deployment-flag=self-execution --jobs=4 --enable-plugin=tk-inter --nofollow-import-to=PyQt5 --nofollow-import-to=PyQt6 --nofollow-import-to=PySide2 --nofollow-import-to=PySide6 main_qt.py
```
